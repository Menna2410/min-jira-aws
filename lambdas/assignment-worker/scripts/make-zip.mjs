/**
 * Builds function.zip next to assignment-worker/package.json for Lambda upload.
 * Run from lambdas/assignment-worker: npm install --omit=dev && npm run package
 */
...
if (isWin) {
  ...
  if (r.status !== 0) {
    console.error("`zip` not found. Install zip (brew install zip) or create function.zip manually.");
